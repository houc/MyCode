...
class SalesSynergyElement(OperationElement):
    """
    封装"SalesSynergyElement"元素类
    Usage:
    ...
    # ================================================元素==========================================
    tab = (By.XPATH, "(//div[@class='ivu-tabs-tab'])[$]")

    def table_text(self, action):
        transfer1 = self.parametrization(self.tab, action)
