...
class TestTask(UnitTests):
    ...
    """
    RE_LOGIN = True
    LOGIN_INFO = {"account": 15800000446, "password": 'Li123456', "company": None}
    ...
    def test_hand_in_is_exist(self):
        """
        验证我的任务“进行中”状态是否存在
        """
        try:
    ...
    @test_re_runner(set_up)
    def test_wait_accept_is_exist(self):
        """
        验证我的任务“待我接受”状态是否存在
        """
        try:
