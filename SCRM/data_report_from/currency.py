...
class DataReportFromElement(OperationElement):
    """
    封装"DataReportFromElement"元素类
    Usage:
    ...
    # ================================================元素==========================================
    time_table = (By.XPATH, "(//span[@class='item'])[$]")

    def time_switch(self, action):
        transfer1 = self.parametrization(self.time_table, action)
