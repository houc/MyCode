...
class TestDebugInterfaceAuxiliary(object):
    """
...
class TestDebugElement(OperationElement):
    """
    封装"TestDebugElement"元素类
    Usage:
    ...
    def __init__(self, driver):
        super(TestDebugElement, self).__init__(driver)
        self.interface = TestDebugInterfaceAuxiliary() # 继承接口类
